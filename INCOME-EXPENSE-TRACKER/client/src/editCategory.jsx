...
const EditCategory = () => {
	...
	useEffect(() => {
		axios.get(`http://localhost:8080/category/edit-category/${_id}`)
			.then((response) => {
	...
	function updateCategory() {
		axios.put(`http://localhost:8080/category/edit-category/${_id}`, categoryData)
			.then((response) => {
	...
	return (
		<div className='min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8'>
			<div className='max-w-md w-full mx-auto space-y-8'>
				<div>
					<h2 className='mt-6 text-center text-3xl font-extrabold text-gray-900 hover:text-gray-700 transition-colors duration-300 cursor-default'>Update Category</h2>
				</div>
